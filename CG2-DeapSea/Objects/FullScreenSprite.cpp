...
void FullScreenSprite::MeshInitialize(FullScreenSpriteCommon* spriteCommon, SRVManager* srvManager_)
{
...
void FullScreenSprite::SpriteInitialize(FullScreenSpriteCommon* spriteCommon, SRVManager* srvManager_, std::string texturefilePath)
{
	this->spriteCommon_ = spriteCommon;
	this->srvManager = srvManager_;
	vertexResource = CreateBufferResource(spriteCommon_, sizeof(VertexData) * 3);
...
void FullScreenSprite::InputData(Vector4 color)
{
	...
	materialData_[0].enableLighting = true;
}

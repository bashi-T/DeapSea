#include "FullScreenSpriteCommon.h"

FullScreenSpriteCommon::~FullScreenSpriteCommon()
{
}
...
ComPtr<IDxcBlob> FullScreenSpriteCommon::CompileShader(const std::wstring& filePath, const wchar_t* profile, IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandler)
{
	debug_->Log(
...
void FullScreenSpriteCommon::ResetDXC()
{
...
FullScreenSpriteCommon* FullScreenSpriteCommon::GetInstance()
{
	if (instance == NULL)
	{
		instance = new FullScreenSpriteCommon;
	}
	return instance;
}
